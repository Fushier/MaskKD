...
from models.util import Embed, ConvReg, LinearEmbed, SelfA, Converter
...
from distiller_zoo import DistillKL, HintLoss, Attention, Similarity, Correlation, VIDLoss, RKDLoss, SemCKDLoss, MaskLoss
...
def main_worker(gpu, ngpus_per_node, opt):
    ...
    if opt.distill == 'kd':
        ...
        converter = Converter(feat_s[:-1], feat_t[:-1])
        module_list.append(converter)
        trainable_list.append(converter)
